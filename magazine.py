    ...
    "shelf": {
        ...
        "sections": [
            {"key": "lead", "title": "货架上的商品", "req": (
                "从贸易中心交易的大宗商品中取最活跃者（按市价推定，不得编造出口量），"
                "写它如何摆上货架：贸易中心等级、生产方法、所有权以数据为准。"
            )},
            {"key": "workshop", "title": "车间里的手", "req": (
                "写该商品本地生产建筑及其工人POP的工作场景：等级、生产方法、所有权、"
            ...
            {"key": "customer", "title": "回家的路", "req": (
                "写目的地顾客POP买到商品后带回家的场景：家庭收支、识字、生活水平为据，"
                "收束全篇，不得编造具体价格以外的数字。"
            )},
        ],
    },
    "service": {
        ...
        "sections": [
            ...
            {"key": "classroom", "title": "课堂与诊室", "req": (
                "以样本州的识字率、政府雇员与基层公职/教员POP，写学校与诊所的具体面貌，"
                "不虚构机构名称。"
            )},
            {"key": "grassroots", "title": "最基层的一天", "req": (
                "以随机州随机下层POP为主角，写国家服务覆盖到最基层的一日：识字、收支、"
    ...
    "letters": {
        ...
        "sections": [
            {"key": "lead", "title": "海外的来信", "req": (
                "报道玩家未并入本土的海外属地：位置、Hub名、主要文化、并入进度，"
                "立起一封家书的背景，不虚构地名。"
            )},
            ...
            {"key": "island", "title": "海外的日子", "req": (
                "以属地居民POP（多为下层）写海外生活的日常：文化、宗教、接受度、收支，"
                "写与本土不同的水土与人情。"
            )},
